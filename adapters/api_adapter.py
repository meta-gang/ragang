...
# Import classes from other modules within the current package (adapters)
...
def initialize_adapters_from_config(config_path: str) -> tuple[BaseLLMAdapter, BaseEmbeddingAdapter]:
    """
